...
class TaskList {
    ...
    getMarkTask(id){
        ...
        document.getElementById('verifyed').classList.toggle('taskDone');
        document.getElementById('taskTitle').classList.toggle('task')
    }
}
